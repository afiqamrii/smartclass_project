...
import 'package:smartclass_fyp_2024/features/super_admin/manage_profile/views/super_admin_edit_profile.dart';
import 'package:smartclass_fyp_2024/shared/data/dataprovider/user_provider.dart';
import 'package:smartclass_fyp_2024/shared/data/models/user.dart';
import 'package:smartclass_fyp_2024/shared/widgets/pageTransition.dart';

class SuperAdminAccountDetails extends ConsumerStatefulWidget {
  const SuperAdminAccountDetails({super.key});

  @override
  ConsumerState<SuperAdminAccountDetails> createState() =>
      _SuperAdminAccountDetailsState();
}

class _SuperAdminAccountDetailsState
    extends ConsumerState<SuperAdminAccountDetails> {
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 10),
                    _classDetails("Staff ID", user.externalId),
                    const SizedBox(height: 10),
                    //Make a horizontal line here
                    Divider(
                      color: Colors.black.withOpacity(0.1),
      ...
      leading: GestureDetector(
        onTap: () {
          Navigator.push(
            context,
            toRightTransition(
              const SuperadminBottomNav(initialIndex: 1),
            ),
          );
        },
        child: const Padding(
