...
class ViewReportDetails extends ConsumerStatefulWidget {
  ...
  const ViewReportDetails({super.key, required this.reportId});
...
class _ViewReportDetailsState extends ConsumerState<ViewReportDetails> {
  ...
  Widget build(BuildContext context) {
    final getReport = ref.watch(reportByIdProvider(widget.reportId));
    ...
    return Scaffold(
      ...
      body: SmartRefresher(
        ...
        child: getReport.when(
          data: (report) {
            _selectedStatus ??= report.issueStatus;
            return ListView(
