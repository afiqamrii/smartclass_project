...
class AcademicianBottomNavbar extends StatefulWidget {
  final int initialIndex;

  const AcademicianBottomNavbar({super.key, required this.initialIndex});

  @override
  State<AcademicianBottomNavbar> createState() => _AcademicianBottomNavbarState();
}

class _AcademicianBottomNavbarState extends State<AcademicianBottomNavbar> {
