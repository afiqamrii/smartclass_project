...
class AcademicianEditProfile extends ConsumerStatefulWidget {
  final User user;

  const AcademicianEditProfile({super.key, required this.user});

  @override
  ConsumerState<AcademicianEditProfile> createState() =>
      _AcademicianEditProfileState();
}

class _AcademicianEditProfileState
    extends ConsumerState<AcademicianEditProfile> {
    ...
    return Scaffold(
        ...
        leading: GestureDetector(
          onTap: () {
            Navigator.push(context,
                toRightTransition(const AcademicAdminAccountDetails()));
          },
          child: const Padding(
      ...
      body: ListView(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          _buildInputField('Staff ID', academicianIdController, onTap: () {
            QuickAlert.show(
              context: context,
